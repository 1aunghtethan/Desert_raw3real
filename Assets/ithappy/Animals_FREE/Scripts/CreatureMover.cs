...
namespace ithappy.Animals_FREE
{
    ...
    public class CreatureMover : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (m_Movement != null)
                m_Movement.Move(Time.deltaTime, in m_Axis, in m_Target, m_IsRun, m_IsMoving, out animAxis, out _);
        ...
        private class MovementHandler
        {
            ...
            {
                if (m_Transform == null || m_Controller == null)
                {
        ...
        private class AnimationHandler
        {
            ...
            private readonly bool m_HasVertical;
            private readonly bool m_HasState;
            ...
            public AnimationHandler(Animator animator, string verticalID, string stateID)
            {
                ...
                if (m_Animator != null)
                {
                    ...
                    {
                        if (parameter.name == m_VerticalID) m_HasVertical = true;
                        if (parameter.name == m_StateID) m_HasState = true;
                    }
                }
            }
            ...
            public void Animate(in Vector2 axis, float state, float deltaTime)
            {
                ...
                if (m_HasVertical) m_Animator.SetFloat(m_VerticalID, m_FlowAxis.magnitude);
                if (m_HasState) m_Animator.SetFloat(m_StateID, Mathf.Clamp01(m_FlowState));
